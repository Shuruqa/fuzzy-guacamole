        ...
        <div class="main-wrapper">
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="row" id="show_no_record"></div>
					<div class="row" id="show_record"></div>
						<!--here this is for projects-->
...
$(function() { 
		...
		var form_data="page=all_search_page&user_login="+user_login+"&user_login_id="+user_login_id;
		$.ajax({
			url:'project_grid_ajax.php',
			type:'POST',
			data:form_data,
			async:true,
			cache: false,
...
$(document).on('submit','#create_project_form',function(e){
	...
	if(/^[a-zA-Z0-9- ]*$/.test(projectid) == false) {
	 $.alert({
		title: 'Alert!',
	...
	if(project_name=='') {
		$.alert({
			title: 'Alert!',
			content: "Please Project name should not be empty.",
		});
			$("#projteam").focus();
			return false;
		  }
 ...
 function add_assign_emp(assign_pro_id,assign_projleader,assign_projteam,assign_dev_id,assign_dev_id1,assigned_date)
  {
	//alert(assign_pro_id);

					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
								<table id="emp_table" class="table table-striped custom-table datatable">
									<thead>
										<tr>
											<th>ID</th>
											<th>Employee Code</th>
...
$(document).on('submit','#search_byempnumber',function(e){
	...
	var form_data="page=employee_search_list&empid_search="+task_status_search+"&empname_search="+empname_search+"&designation_search="+designation_search;
	$.ajax({
...
$(document).on('submit','#create_employee_form',function(e){
 ...
 function edit_new_employee(empnumber,fullname,add_designation,email,joining_date,phonenumber,add_gender,company_name,college_name,major_name,prev_empr,pre_position)
    { 
